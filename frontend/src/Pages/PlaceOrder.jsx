...
const PlaceOrder = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    // Prevent Stripe payment method and show toast message
    if (paymentMethod === 'stripe') {
      toast.error("Sorry, Stripe is not available at our country");
      return; // Stop further execution if Stripe is selected
    }
